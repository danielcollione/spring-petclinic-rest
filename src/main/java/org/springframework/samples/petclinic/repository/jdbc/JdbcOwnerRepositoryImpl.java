...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
    ...
    public Collection<Owner> findByLastName(String lastName) throws DataAccessException {
        ...
        List<Owner> owners = this.namedParameterJdbcTemplate.query(
            "SELECT id, first_name, last_name, address, city, telephone, online FROM owners WHERE last_name like :lastName",
            params,
    ...
    public Owner findById(int id) throws DataAccessException {
        ...
        try {
            ...
            owner = this.namedParameterJdbcTemplate.queryForObject(
                "SELECT id, first_name, last_name, address, city, telephone, online FROM owners WHERE id= :id",
                params,
                BeanPropertyRowMapper.newInstance(Owner.class)
            );
        ...
        if (owner.isNew()) {
            ...
            this.namedParameterJdbcTemplate.update(
                "UPDATE owners SET first_name=:firstName, last_name=:lastName, address=:address, " +
                    "city=:city, telephone=:telephone, online=:online WHERE id=:id",
                parameterSource);
        }
    }
	...
	public Collection<Owner> findAll() throws DataAccessException {
		List<Owner> owners = this.namedParameterJdbcTemplate.query(
	            "SELECT id, first_name, last_name, address, city, telephone, online FROM owners",
